...
const Button = ({ children, onClick, variant = 'primary', className = '', icon: Icon, size = 'md', disabled = false, type = 'button' }: any) => {
...
const Community = () => {
  ...
  const handleAddComment = (e: React.MouseEvent, postId: string) => {
      e.stopPropagation();
                 ...
                 <div className="mt-4 pt-4 border-t border-stone-50 animate-slideUp">
                    ...
                    <div className="flex gap-2">
                        <Input 
                           ...
                           className="flex-1"
                           onKeyDown={(e: any) => e.key === 'Enter' && handleAddComment(e, post.id)}
                        />
                        <button 
                          type="button"
